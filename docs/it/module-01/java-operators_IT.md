...
- [5. Operatori Java](#5-java-operators)
  - [5.1 Definizione](#51-definition)
  - [5.2 Tipi di operatori](#52-types-of-operators)
  - [5.3 Categorie di operatori](#53-categories-of-operators)
  - [5.4 Precedenza degli operatori e ordine di valutazione](#54-operator-precedence-and-order-of-evaluation)
  - [5.5 Tabella riassuntiva degli operatori Java](#55-summary-table-of-java-operators)
    - [5.5.1 Note aggiuntive](#551-additional-notes)
  - [5.6 Operatori unari](#56-unary-operators)
    - [5.6.1 Categorie di operatori unari](#561-categories-of-unary-operators)
    - [5.6.2 Esempi](#562-examples)
  - [5.7 Operatori binari](#57-binary-operators)
    - [5.7.1 Categorie di operatori binari](#571-categories-of-binary-operators)
    - [5.7.2 Operatori di divisione e resto (modulus)](#572-division-and-modulus-operators)
    - [5.7.3 Il valore di ritorno dell’operatore di assegnazione](#573-the-return-value-of-an-assignment-operator)
    - [5.7.4 Operatori di assegnazione composta](#574-compound-assignment-operators)
    - [5.7.5 Operatori di uguaglianza == e !=](#575-equality-operators--and-)
      - [5.7.5.1 Uguaglianza con tipi primitivi](#5751-equality-with-primitive-types)
      - [5.7.5.2 Uguaglianza con tipi reference (oggetti)](#5752-equality-with-reference-types-objects)
    - [5.7.6 L’operatore instanceof](#576-the-instanceof-operator)
      - [5.7.6.1 Controllo in fase di compilazione vs fase di esecuzione](#5761-compile-time-check-vs-runtime-check)
      - [5.7.6.2 Pattern matching per instanceof](#5762-pattern-matching-for-instanceof)
      - [5.7.6.3 Flow scoping e logica short-circuit](#5763-flow-scoping--short-circuit-logic)
      - [5.7.6.4 Array e tipi reificabili](#5764-arrays-and-reifiable-types)
  - [5.8 Operatore ternario](#58-ternary-operator)
    - [5.8.1 Sintassi](#581-syntax)
    - [5.8.2 Esempio](#582-example)
    - [5.8.3 Esempio di ternario annidato](#583-nested-ternary-example)
    - [5.8.4 Note](#584-notes)

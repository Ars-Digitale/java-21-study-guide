...
- [6. Istanziazione dei tipi](#6-instantiating-types)
  - [6.1 Istanziazione dei tipi](#61-instantiating-types)
    - [6.1.1 Gestione dei tipi primitivi](#611-handling-primitive-types)
      - [6.1.1.1 Dichiarare un primitivo](#6111-declaring-a-primitive)
      - [6.1.1.2 Assegnare un primitivo](#6112-assigning-a-primitive)
    - [6.1.2 Gestione dei tipi riferimento](#612-handling-reference-types)
      - [6.1.2.1 Creare e assegnare un riferimento](#6121-creating-and-assigning-a-reference)
      - [6.1.2.2 Costruttori](#6122-constructors)
      - [6.1.2.3 Blocchi di inizializzazione d’istanza](#6123-instance-initializer-blocks)
  - [6.2 Inizializzazione predefinita delle variabili](#62-default-variable-initialization)
    - [6.2.1 Variabili di istanza e di classe](#621-instance-and-class-variables)
    - [6.2.2 Variabili final di istanza](#622-final-instance-variables)
    - [6.2.3 Variabili locali](#623-local-variables)
      - [6.2.3.1 Inferire i tipi con var](#6231-inferring-types-with-var)
  - [6.3 Tipi wrapper](#63-wrapper-types)
    - [6.3.1 Scopo dei tipi wrapper](#631-purpose-of-wrapper-types)
    - [6.3.2 Autoboxing e unboxing](#632-autoboxing-and-unboxing)
    - [6.3.3 Parsing e conversione](#633--parsing-and-conversion)
    - [6.3.4 Metodi di supporto](#634--helper-methods)
    - [6.3.5 Valori null](#635--null-values)
  - [6.4 Uguaglianza in Java](#64-equality-in-java)
    - [6.4.1 Uguaglianza con i tipi primitivi](#641-equality-with-primitive-types)
      - [6.4.1.1 Punti chiave](#6411-key-points)
    - [6.4.2 Uguaglianza con i tipi riferimento](#642-equality-with-reference-types)
      - [6.4.2.1 Confronto di identità](#6421-identity-comparison)
      - [6.4.2.2 equals Confronto logico](#6422-equals-logical-comparison)
      - [6.4.2.3 Punti chiave](#6423-key-points)
  - [6.4.3 String Pool e uguaglianza](#643-string-pool-and-equality)
      - [6.4.3.1 Il metodo intern](#6431-the-intern-method)
    - [6.4.4 Uguaglianza con i tipi wrapper](#644-equality-with-wrapper-types)
    - [6.4.5 Uguaglianza e null](#645-equality-and-null)
    - [6.4.6 Tabella riepilogativa](#646-summary-table)

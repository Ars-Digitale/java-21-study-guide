...
- [9. Stringhe in Java](#9-strings-in-java)
	- [9.1 Stringhe & Text Blocks](#91-strings--text-blocks)
		- [9.1.1 Stringhe](#911-strings)
			- [9.1.1.1 Inizializzare le stringhe](#9111-initializing-strings)
			- [9.1.1.2 Il String Pool](#9112-the-string-pool)
			- [9.1.1.3 Caratteri speciali e sequenze di escape](#9113-special-characters-and-escape-sequences)
			- [9.1.1.4 Regole per la concatenazione di stringhe](#9114-rules-for-string-concatenation)
			- [9.1.1.5 Regole di concatenazione](#9115-concatenation-rules)
		- [9.1.2 Text Blocks (da Java 15)](#912-text-blocks-since-java-15)
			- [9.1.2.1 Formattazione: whitespace essenziale vs incidentale](#9121-formatting-essential-vs-incidental-whitespace)
			- [9.1.2.2 Conteggio righe, righe vuote e line break](#9122-line-count-blank-lines-and-line-breaks)
			- [9.1.2.3 Text Blocks e caratteri di escape](#9123-text-blocks--escape-characters)
			- [9.1.2.4 Errori comuni con correzioni](#9124-common-errors-with-fixes)
	- [9.2 Metodi principali delle stringhe](#92-core-string-methods)
		- [9.2.1 Indicizzazione delle stringhe](#921-string-indexing)
		- [9.2.2 Metodo length](#922-length-method)
		- [9.2.3 Regole dei limiti: indice iniziale vs indice finale](#923-boundary-rules-start-index-vs-end-index)
		- [9.2.4 Metodi che usano solo l’indice iniziale (inclusivo)](#924-methods-using-only-start-index-inclusive)
		- [9.2.5 Metodi con inizio inclusivo / fine esclusivo](#925-methods-with-start-inclusive--end-exclusive)
		- [9.2.6 Metodi che operano sull’intera stringa](#926-methods-that-operate-on-entire-string)
		- [9.2.7 Accesso ai caratteri](#927-character-access)
		- [9.2.8 Ricerca](#928-searching)
		- [9.2.9 Metodi di sostituzione](#929-replacement-methods)
		- [9.2.10 Suddivisione e unione](#9210-splitting-and-joining)
		- [9.2.11 Metodi che restituiscono array](#9211-methods-returning-arrays)
		- [9.2.12 Indentazione](#9212-indentation)
		- [9.2.13 Esempi aggiuntivi](#9213-additional-examples)

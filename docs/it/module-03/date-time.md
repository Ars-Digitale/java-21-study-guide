...
- [12. Data e ora in Java](#12-data-e-ora-in-java)
	- [12.1 Data e ora](#121-data-e-ora)
		- [12.1.1 Creare date e ore specifiche](#1211-creare-date-e-ore-specifiche)
		- [12.1.2 Aritmetica su data e ora: metodi plus e minus](#1212-aritmetica-su-data-e-ora-metodi-plus-e-minus)
		- [12.1.3 Pattern comuni](#1213-pattern-comuni)
		- [12.1.4 Aritmetica su LocalDate](#1214-aritmetica-su-localdate)
		- [12.1.5 Aritmetica su LocalTime](#1215-aritmetica-su-localtime)
		- [12.1.6 Aritmetica su LocalDateTime](#1216-aritmetica-su-localdatetime)
		- [12.1.7 Aritmetica su ZonedDateTime](#1217-aritmetica-su-zoneddatetime)
		- [12.1.8 Tabella riassuntiva](#1218-tabella-riassuntiva)
	- [12.2 Metodi withXxx](#122-metodi-withxxx)
	- [12.3 Conversione e metodi at: collegare data, ora e zona](#123-conversione-e-metodi-at-collegare-data-ora-e-zona)
	- [12.4 Period, Duration e Instant](#124-period-duration-e-instant)
	- [12.5 Period — quantità “umane” di data](#125-period--quantità-umane-di-data)
	- [12.6 Duration — quantità “macchina” di tempo](#126-duration--quantità-macchina-di-tempo)
	- [12.7 Instant — punto sulla timeline UTC](#127-instant--punto-sulla-timeline-utc)
	- [12.8 Tabella riassuntiva: Period vs Duration vs Instant](#128-tabella-riassuntiva-period-vs-duration-vs-instant)
	- [12.9 TemporalUnit e TemporalAmount](#129-temporalunit-e-temporalamount)
		...
		- [12.9.4 Period come TemporalAmount](#1294-period-come-temporalamount)
		- [12.9.5 Duration come TemporalAmount](#1295-duration-come-temporalamount)
		- [12.9.6 Usare TemporalAmount vs TemporalUnit](#1296-usare-temporalamount-vs-temporalunit)
		- [12.9.7 Metodi between](#1297-metodi-between)
		- [12.9.8 Problemi comuni](#1298-problemi-comuni)
		- [12.9.9 Riepilogo](#1299-riepilogo)

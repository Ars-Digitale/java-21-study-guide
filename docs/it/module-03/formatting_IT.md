...
- [13. Formattazione e Localizzazione in Java](#13-formatting-and-localizing-in-java)
   - [13.1 Formattazione delle Stringhe](#131-string-formatting)
     - [13.1.1 String.format e formatted](#1311-stringformat-and-formatted)
       - [13.1.1.1 Flag per numeri in virgola mobile](#13111-floating-point-flags)
       - [13.1.1.2 Precisione n](#13112-precision-n)
       - [13.1.1.3 Larghezza m](#13113-width-m)
       - [13.1.1.4 Flag di riempimento con zero 0](#13114-zero-padding-0-flag)
       - [13.1.1.5 Giustificazione a sinistra Flag -](#13115-left-justification---flag)
       - [13.1.1.6 Segno esplicito Flag +](#13116-explicit-sign--flag)
       - [13.1.1.7 Parentesi per i negativi Flag (](#13117-parentheses-for-negatives--flag)
       - [13.1.1.8 Combinazione dei flag](#13118-combining-flags)
       - [13.1.1.9 Effetti del Locale](#13119-locale-effects)
       - [13.1.1.10 Errori comuni](#131110-common-pitfalls)
     - [13.1.2 Valori di testo personalizzati ed escaping](#1312-custom-text-values-and-escaping)
   - [13.2 Formattazione dei Numeri](#132-number-formatting)
     - [13.2.1 NumberFormat](#1321-numberformat)
     - [13.2.2 Localizzazione dei numeri](#1322-localizing-numbers)
     - [13.2.3 DecimalFormat e NumberFormat](#1323-decimalformat-and-numberformat)
     - [13.2.4 Struttura del pattern DecimalFormat](#1324-decimalformat-pattern-structure)
     - [13.2.5 Il simbolo 0 (cifra obbligatoria)](#1325-the-0-symbol-mandatory-digit)
     - [13.2.6 Il simbolo # (cifra opzionale)](#1326-the--symbol-optional-digit)
     - [13.2.7 Combinare 0 e #](#1327-combining-0-and-)
     - [13.2.8 Separatori decimali e di raggruppamento](#1328-decimal-and-grouping-separators)
     - [13.2.9 DecimalFormatSymbols: simboli di formattazione specifici del Locale](#1329-decimalformatsymbols-locale-specific-formatting-symbols)
     - [13.2.10 Pattern speciali di DecimalFormat](#13210-special-decimalformat-patterns)
     - [13.2.11 Regole ed errori comuni](#13211-common-rules-and-pitfalls)
   - [13.3 Parsing dei Numeri](#133-parsing-numbers)
     - [13.3.1 Parsing con DecimalFormat](#1331-parsing-with-decimalformat)
     - [13.3.2 CompactNumberFormat](#1332-compactnumberformat)
   - [13.4 Formattazione di Data e Ora](#134-date-and-time-formatting)
     - [13.4.1 DateTimeFormatter](#1341-datetimeformatter)
     - [13.4.2 Simboli standard di data e ora](#1342-standard-datetime-symbols)
     - [13.4.3 datetime.format vs formatter.format](#1343-datetimeformat-vs-formatterformat)
     - [13.4.4 Localizzazione delle date](#1344-localizing-dates)

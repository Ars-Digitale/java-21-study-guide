...
- [10. Array in Java](#10-arrays-in-java)
	- [10.1 Che cos’è un array](#101-what-an-array-is)
		- [10.1.1 Dichiarare gli array](#1011-declaring-arrays)
		- [10.1.2 Creare array (istanza)](#1012-creating-arrays-instantiation)
		- [10.1.3 Valori predefiniti negli array](#1013-default-values-in-arrays)
		- [10.1.4 Accedere agli elementi](#1014-accessing-elements)
		- [10.1.5 Scorciatoie di inizializzazione degli array](#1015-array-initialization-shorthands)
			- [10.1.5.1 Creazione di array anonimi](#10151-anonymous-array-creation)
			- [10.1.5.2 Sintassi breve (solo in dichiarazione)](#10152-short-syntax-only-at-declaration)
	- [10.2 Array multidimensionali (array di array)](#102-multidimensional-arrays-arrays-of-arrays)
		- [10.2.1 Creare un array rettangolare](#1021-creating-a-rectangular-array)
		- [10.2.2 Creare un array frastagliato (irregolare)](#1022-creating-a-jagged-irregular-array)
	- [10.3 Lunghezza degli array vs lunghezza delle stringhe](#103-array-length-vs-string-length)
	- [10.4 Assegnazioni di riferimenti a array](#104-array-reference-assignments)
		- [10.4.1 Assegnare riferimenti compatibili](#1041-assigning-compatible-references)
		- [10.4.2 Assegnazioni incompatibili (errori a compile-time)](#1042-incompatible-assignments-compile-time-errors)
		- [10.4.3 Rischio runtime della covarianza: ArrayStoreException](#1043-covariance-runtime-danger-arraystoreexception)
	- [10.5 Confrontare gli array](#105-comparing-arrays)
	- [10.6 Metodi di utilità di Arrays](#106-arrays-utility-methods)
		- [10.6.1 Arrays.toString](#1061-arraystostring)
		- [10.6.2 Arrays.deepToString per array annidati](#1062-arraysdeeptostring-for-nested-arrays)
	...
	- [10.7 Enhanced for-loop con array](#107-enhanced-for-loop-with-arrays)
	- [10.8 Errori comuni](#108-common-pitfalls)
	- [10.9 Riepilogo](#109-summary)

...
- [10. Tableaux en Java](#10-arrays-in-java)
	- [10.1 Ce qu’est un tableau](#101-what-an-array-is)
		- [10.1.1 Déclarer des tableaux](#1011-declaring-arrays)
		- [10.1.2 Créer des tableaux (instanciation)](#1012-creating-arrays-instantiation)
		- [10.1.3 Valeurs par défaut dans les tableaux](#1013-default-values-in-arrays)
		- [10.1.4 Accéder aux éléments](#1014-accessing-elements)
		- [10.1.5 Raccourcis d’initialisation de tableaux](#1015-array-initialization-shorthands)
			- [10.1.5.1 Création anonyme de tableau](#10151-anonymous-array-creation)
			- [10.1.5.2 Syntaxe courte (uniquement à la déclaration)](#10152-short-syntax-only-at-declaration)
	- [10.2 Tableaux multidimensionnels (tableaux de tableaux)](#102-multidimensional-arrays-arrays-of-arrays)
		- [10.2.1 Créer un tableau rectangulaire](#1021-creating-a-rectangular-array)
		- [10.2.2 Créer un tableau dentelé (irrégulier)](#1022-creating-a-jagged-irregular-array)
	- [10.3 Longueur d’un tableau vs longueur d’une chaîne](#103-array-length-vs-string-length)
	- [10.4 Affectations de références de tableaux](#104-array-reference-assignments)
		- [10.4.1 Affecter des références compatibles](#1041-assigning-compatible-references)
		- [10.4.2 Affectations incompatibles (erreurs à la compilation)](#1042-incompatible-assignments-compile-time-errors)
		- [10.4.3 Danger d’exécution de la covariance : ArrayStoreException](#1043-covariance-runtime-danger-arraystoreexception)
	- [10.5 Comparer des tableaux](#105-comparing-arrays)
	- [10.6 Méthodes utilitaires de Arrays](#106-arrays-utility-methods)
		- [10.6.1 Arrays.toString](#1061-arraystostring)
		- [10.6.2 Arrays.deepToString pour les tableaux imbriqués](#1062-arraysdeeptostring-for-nested-arrays)
	...
	- [10.7 Boucle for améliorée avec les tableaux](#107-enhanced-for-loop-with-arrays)
	- [10.8 Pièges courants](#108-common-pitfalls)
	- [10.9 Résumé](#109-summary)

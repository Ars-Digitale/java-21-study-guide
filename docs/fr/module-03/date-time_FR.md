...
- [12. Date et heure en Java](#12-date-and-time-in-java)
	- [12.1 Date et heure](#121-date-and-time)
		- [12.1.1 Créer des dates et heures spécifiques](#1211-creating-specific-dates-and-times)
		- [12.1.2 Arithmétique date/heure : méthodes plus et minus](#1212-date-and-time-arithmetic-plus-and-minus-methods)
		- [12.1.3 Modèles courants](#1213-common-patterns)
		- [12.1.4 Arithmétique LocalDate](#1214-localdate-arithmetic)
		- [12.1.5 Arithmétique LocalTime](#1215-localtime-arithmetic)
		- [12.1.6 Arithmétique LocalDateTime](#1216-localdatetime-arithmetic)
		- [12.1.7 Arithmétique ZonedDateTime](#1217-zoneddatetime-arithmetic)
		- [12.1.8 Tableau récapitulatif](#1218-summary-table)
	- [12.2 Méthodes withXxx](#122-withxxx-methods)
	- [12.3 Conversion et méthodes at (lier date, heure et zone)](#123-conversion--at-methods-linking-date-time-and-zone)
	- [12.4 Period, Duration et Instant](#124-period-duration-and-instant)
	- [12.5 Period — Durées humaines basées sur la date](#125-period--human-date-amounts)
	- [12.6 Duration — Durées machine basées sur le temps](#126-duration--machine-time-amounts)
	- [12.7 Instant — Point sur la chronologie UTC](#127-instant--point-on-the-utc-timeline)
	- [12.8 Tableau récapitulatif : Period vs Duration vs Instant](#128-summary-table-period-vs-duration-vs-instant)
	- [12.9 TemporalUnit et TemporalAmount](#129-temporalunit-and-temporalamount)
		...
		- [12.9.4 Period en tant que TemporalAmount](#1294-period-as-a-temporalamount)
		- [12.9.5 Duration en tant que TemporalAmount](#1295-duration-as-a-temporalamount)
		- [12.9.6 Utiliser TemporalAmount vs TemporalUnit](#1296-using-temporalamount-vs-temporalunit)
		- [12.9.7 Méthodes between](#1297-between-methods)
		- [12.9.8 Pièges courants](#1298-common-pitfalls)
		- [12.9.9 Résumé](#1299-summary)

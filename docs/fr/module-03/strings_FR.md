...
- [9. Chaînes de caractères en Java](#9-strings-in-java)
	- [9.1 Chaînes & Text Blocks](#91-strings--text-blocks)
		- [9.1.1 Chaînes](#911-strings)
			- [9.1.1.1 Initialiser des chaînes](#9111-initializing-strings)
			- [9.1.1.2 Le String Pool](#9112-the-string-pool)
			- [9.1.1.3 Caractères spéciaux et séquences d’échappement](#9113-special-characters-and-escape-sequences)
			- [9.1.1.4 Règles de concaténation des chaînes](#9114-rules-for-string-concatenation)
			- [9.1.1.5 Règles de concaténation](#9115-concatenation-rules)
		- [9.1.2 Text Blocks (depuis Java 15)](#912-text-blocks-since-java-15)
			- [9.1.2.1 Mise en forme : espaces essentiels vs incidentels](#9121-formatting-essential-vs-incidental-whitespace)
			- [9.1.2.2 Nombre de lignes, lignes vides et retours à la ligne](#9122-line-count-blank-lines-and-line-breaks)
			- [9.1.2.3 Text Blocks et caractères d’échappement](#9123-text-blocks--escape-characters)
			- [9.1.2.4 Erreurs courantes (avec corrections)](#9124-common-errors-with-fixes)
	- [9.2 Méthodes principales des chaînes](#92-core-string-methods)
		- [9.2.1 Indexation des chaînes](#921-string-indexing)
		- [9.2.2 Méthode length](#922-length-method)
		- [9.2.3 Règles de bornes : index de début vs index de fin](#923-boundary-rules-start-index-vs-end-index)
		- [9.2.4 Méthodes utilisant uniquement l’index de début (inclusif)](#924-methods-using-only-start-index-inclusive)
		- [9.2.5 Méthodes avec début inclusif / fin exclusive](#925-methods-with-start-inclusive--end-exclusive)
		- [9.2.6 Méthodes opérant sur toute la chaîne](#926-methods-that-operate-on-entire-string)
		- [9.2.7 Accès aux caractères](#927-character-access)
		- [9.2.8 Recherche](#928-searching)
		- [9.2.9 Méthodes de remplacement](#929-replacement-methods)
		- [9.2.10 Découpage et jonction](#9210-splitting-and-joining)
		- [9.2.11 Méthodes retournant des tableaux](#9211-methods-returning-arrays)
		- [9.2.12 Indentation](#9212-indentation)
		- [9.2.13 Exemples supplémentaires](#9213-additional-examples)

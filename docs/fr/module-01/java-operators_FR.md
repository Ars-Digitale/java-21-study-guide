...
- [5. Opérateurs Java](#5-java-operators)
  - [5.1 Définition](#51-definition)
  - [5.2 Types d’opérateurs](#52-types-of-operators)
  - [5.3 Catégories d’opérateurs](#53-categories-of-operators)
  - [5.4 Priorité des opérateurs et ordre d’évaluation](#54-operator-precedence-and-order-of-evaluation)
  - [5.5 Tableau récapitulatif des opérateurs Java](#55-summary-table-of-java-operators)
    - [5.5.1 Notes complémentaires](#551-additional-notes)
  - [5.6 Opérateurs unaires](#56-unary-operators)
    - [5.6.1 Catégories d’opérateurs unaires](#561-categories-of-unary-operators)
    - [5.6.2 Exemples](#562-examples)
  - [5.7 Opérateurs binaires](#57-binary-operators)
    - [5.7.1 Catégories d’opérateurs binaires](#571-categories-of-binary-operators)
    - [5.7.2 Opérateurs de division et de modulo (reste)](#572-division-and-modulus-operators)
    - [5.7.3 La valeur de retour de l’opérateur d’affectation](#573-the-return-value-of-an-assignment-operator)
    - [5.7.4 Opérateurs d’affectation composée](#574-compound-assignment-operators)
    - [5.7.5 Opérateurs d’égalité == et !=](#575-equality-operators--and-)
      - [5.7.5.1 Égalité avec les types primitifs](#5751-equality-with-primitive-types)
      - [5.7.5.2 Égalité avec les types référence (objets)](#5752-equality-with-reference-types-objects)
    - [5.7.6 L’opérateur instanceof](#576-the-instanceof-operator)
      - [5.7.6.1 Vérification à la compilation vs à l’exécution](#5761-compile-time-check-vs-runtime-check)
      - [5.7.6.2 Pattern matching pour instanceof](#5762-pattern-matching-for-instanceof)
      - [5.7.6.3 Flow scoping & logique short-circuit](#5763-flow-scoping--short-circuit-logic)
      - [5.7.6.4 Tableaux et types réifiables](#5764-arrays-and-reifiable-types)
  - [5.8 Opérateur ternaire](#58-ternary-operator)
    - [5.8.1 Syntaxe](#581-syntax)
    - [5.8.2 Exemple](#582-example)
    - [5.8.3 Exemple de ternaire imbriqué](#583-nested-ternary-example)

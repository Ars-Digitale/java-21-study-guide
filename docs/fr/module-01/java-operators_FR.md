...
- [5. Opérateurs Java](#5-opérateurs-java)
  ...
  - [5.2 Types d’opérateurs](#52-types-d’opérateurs)
  - [5.3 Catégories d’opérateurs](#53-catégories-d’opérateurs)
  ...
  - [5.6 Opérateurs unaires](#56-opérateurs-unaires)
    - [5.6.1 Catégories d’opérateurs unaires](#561-catégories-d’opérateurs-unaires)
    - [5.6.2 Exemples](#562-exemples)
  - [5.7 Opérateurs binaires](#57-opérateurs-binaires)
    - [5.7.1 Catégories d’opérateurs binaires](#571-catégories-d’opérateurs-binaires)

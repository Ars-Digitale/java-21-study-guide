...
- [6. Instanciation des types](#6-instantiating-types)
  - [6.1 Instanciation des types](#61-instantiating-types)
    - [6.1.1 Gestion des types primitifs](#611-handling-primitive-types)
      - [6.1.1.1 Déclarer un primitif](#6111-declaring-a-primitive)
      - [6.1.1.2 Affecter un primitif](#6112-assigning-a-primitive)
    - [6.1.2 Gestion des types référence](#612-handling-reference-types)
      - [6.1.2.1 Créer et affecter une référence](#6121-creating-and-assigning-a-reference)
      - [6.1.2.2 Constructeurs](#6122-constructors)
      - [6.1.2.3 Blocs d’initialisation d’instance](#6123-instance-initializer-blocks)
  - [6.2 Initialisation par défaut des variables](#62-default-variable-initialization)
    - [6.2.1 Variables d’instance et de classe](#621-instance-and-class-variables)
    - [6.2.2 Variables d’instance final](#622-final-instance-variables)
    - [6.2.3 Variables locales](#623-local-variables)
      - [6.2.3.1 Inférer les types avec var](#6231-inferring-types-with-var)
  - [6.3 Types wrapper](#63-wrapper-types)
    - [6.3.1 Objectif des types wrapper](#631-purpose-of-wrapper-types)
    - [6.3.2 Autoboxing et unboxing](#632-autoboxing-and-unboxing)
    - [6.3.3 Parsing et conversion](#633--parsing-and-conversion)
    - [6.3.4 Méthodes utilitaires](#634--helper-methods)
    - [6.3.5 Valeurs null](#635--null-values)
  - [6.4 Égalité en Java](#64-equality-in-java)
    - [6.4.1 Égalité avec les types primitifs](#641-equality-with-primitive-types)
      - [6.4.1.1 Points clés](#6411-key-points)
    - [6.4.2 Égalité avec les types référence](#642-equality-with-reference-types)
      - [6.4.2.1 Comparaison d’identité](#6421-identity-comparison)
      - [6.4.2.2 equals Comparaison logique](#6422-equals-logical-comparison)
      - [6.4.2.3 Points clés](#6423-key-points)
  - [6.4.3 String Pool et égalité](#643-string-pool-and-equality)
      - [6.4.3.1 La méthode intern](#6431-the-intern-method)
    - [6.4.4 Égalité avec les types wrapper](#644-equality-with-wrapper-types)
    - [6.4.5 Égalité et null](#645-equality-and-null)
    - [6.4.6 Tableau récapitulatif](#646-summary-table)

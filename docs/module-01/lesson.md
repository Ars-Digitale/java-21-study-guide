...
It represents a user-defined Type which, as defined in programming language theory [See Syntax Building Blocks](syntax-building-bloks), specifies the kind of data and the operations (methods) that this new type supports.

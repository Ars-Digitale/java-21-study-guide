...
- **<kbd>Ctrl</kbd> + <kbd>⇧</kbd> +C**  -----  ** <kbd>⌘</kbd> + /** - Toggle comment on selected lines
- **<kbd>Ctrl</kbd> + <kbd>⇧</kbd> + /**  -----  **^ + <kbd>⌘</kbd> + /** - Add block comment
- **<kbd>Ctrl</kbd> + <kbd>⇧</kbd> + \\**  -----  **^ +<kbd>⌘</kbd> + \\** - Remove block comment